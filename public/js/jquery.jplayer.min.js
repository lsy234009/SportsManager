...
})(this, function (b, f) {//b is the  jQuery
	b.fn.jPlayer = function (a) {//绑定 jPlayer 方法
//		alert(a);
...
//			alert("before");
	...
	b.jPlayer = function (a, c) {//绑定全局 方法
		if (arguments.length) {
//			alert(c.id);   jplayer 标签
			this.element = b(c);
...
//			alert(a.options);
		...
		_addHtmlEventListeners : function (a, c) {
			...
			a.addEventListener("pause", function () {
				...
				!1);
//			alert("add Html Listeners");
			a.addEventListener("waiting", function () {
//				alert("add waiting function");///////////////////////////////////
				c.gate && (d._seeking(), d._trigger(b.jPlayer.event.waiting))
			}, !1);
			a.addEventListener("seeking", function () {
//				alert("add seeking function");//////////////////////////////
...
//			alert("loading");
		...
		seekBar : function (a) {
			//alert("here is seekBar");
			try{
				//alert(this.css.jq.seekBar.length);
...
//					alert(d.seekable.length);
					d.currentTime = a * d.seekable.end(d.seekable.length - 1) / 100;
				}
				else if (0 < d.duration && !isNaN(d.duration)){
					//alert("currentTime+"+d.currentTime);
//					alert(a);
					tt=a * d.duration / 100;
					//alert(tt);
					d.currentTime = a * d.duration / 100; //Text

//					d.currentTime.replaceData(0,17,d.currentTime);//a * d.duration / 100; Text
//					alert(d.currentTime);
				}
				else
					throw "e";
